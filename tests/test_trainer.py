...
class TrainerTest(unittest.TestCase):
    ...
    @mock.patch('cherry.trainer.Trainer.train')
    def test_init_load_data(self, mock_train, mock_cache, mock_load):
    ...
    @mock.patch('cherry.trainer.Trainer._write_cache')
    @mock.patch('cherry.trainer.Trainer.train')
    def test_init_pass_data(self, mock_train, mock_cache, mock_load):
        mock_load.return_value = self.x_data, self.y_data
        t = Trainer(
            model='harmful', vectorizer=None, vectorizer_method=None,
            clf=None, clf_method=None, x_data=self.x_data, y_data=self.y_data)
    ...
    @mock.patch('cherry.trainer.Trainer._write_cache')
    @mock.patch('cherry.trainer.Trainer.train')
    def test_init_no_clf(self, mock_train, mock_cache, mock_clf):
        t = Trainer(
            model='harmful', vectorizer=None, vectorizer_method=None,
            clf=None, clf_method=None, x_data=self.x_data, y_data=self.y_data)
    ...
    @mock.patch('cherry.trainer.Trainer._write_cache')
    @mock.patch('cherry.trainer.Trainer.train')
    def test_init_train(self, mock_train, mock_cache):
        t = Trainer(
            model='harmful', vectorizer=None, vectorizer_method=None,
            clf=None, clf_method=None, x_data=self.x_data, y_data=self.y_data)
    ...
    def test_train_fit(self, mock_fit, mock_cache):
        t = Trainer(
            model='harmful', vectorizer=None, vectorizer_method=None,
            clf=None, clf_method=None, x_data=self.x_data, y_data=self.y_data)
